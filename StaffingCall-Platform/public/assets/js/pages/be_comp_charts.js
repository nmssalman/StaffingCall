...
var BeCompCharts = function() {
    ...
    var initChartsChartJS = function () {
        ...
        var chartBarsConTwo   = jQuery('.js-chartjs-bars-two');
        ...
        var chartLinesBarsRadarData, chartPolarPieDonutData, chartLinesBarsRadarDataTwo;
...
//                }
        ...
        var chartLinesBarsRadarDataTwo = {
...
//                }
        ...
        if ( chartBarsConTwo.length ) {
            chartBars  = new Chart(chartBarsConTwo, { type: 'bar', data: chartLinesBarsRadarDataTwo });
        }
    ...
    var initChartsFlot = function(){
        ...
        var dataSales       = [[1, 50], [2, 60], [3, 40], [4, 75], [5, 115], [6, 95], [7, 140], [8, 170], [9, 180], [10, 130], [11, 175], [12, 290]];
