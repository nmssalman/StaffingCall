    ...
    return function(t) {
            ...
            p = function(t) {
                ...
                return i.__extends(e, t), e.prototype.addChild = function(t) {
                    ...
                    return o.isPlainObject(t) ? (r = t.date, i = t.type, s = t.forceOff) : r = t, r = l.default(r), u = {
                        ...
                        type: i || "day"
                    }, "string" == typeof e && (n = e, e = null), e = e ? " " + a.attrsToStr(e) : "", n = n || "", !s && this.opt("navLinks") ? "<a" + e + ' data-goto_="' + a.htmlEscape(JSON.stringify(u)) + '">' + n + "</a>" : "<span" + e + ">" + n + "</span>"
        ...
        var o = n(0),
            ...
            u = function(t) {
                    ...
                    for (r = 0; r < h; r++) {
                        if (i = p[r], o = 0, a = s("<tr/>"), g.push([]), v.push([]), y.push([]), i)
                            for (l = 0; l < i.length; l++) {
                                for (u = i[l], n(u.leftCol), d = s('<td class="fc-event-containerR"/>').append(u.el), u.leftCol != u.rightCol ? d.attr("colspan", u.rightCol - u.leftCol + 1) : y[r][o] = d; o <= u.rightCol;) v[r][o] = d, g[r][o] = u, o++;
                                a.append(d)
                ...
                var blockColorClass = o.miscProps.shiftType;
...
//                }
                /* Change color of Shift */
                    ...
                    return c.unshift("fc-day-grid-event", "fc-h-event"), t.isStart && (n = this.getTimeText(t.footprint)) && (h = '<span class="fc-time">' + a.htmlEscape(n) + "</span>"), r = blockShiftIcon+' <span class="fc-title">' + (a.htmlEscape(o.title || "") || "&nbsp;") + "</span>", '<a style="" class="'+blockColorClass+' ' + c.join(" ") + '"' + (o.url ? ' href="' + a.htmlEscape(o.url) + '"' : "") + (p ? ' style="' + p + '"' : "") + '><div class="fc-content">' + (this.dayGrid.isRTL ? r + " " + h : h + " " + r) + "</div>" + (u ? '<div class="fc-resizer fc-start-resizer" />' : "") + (d ? '<div class="fc-resizer fc-end-resizer" />' : "") + "</a>"
                }, e
            }(l.default);
        e.default = u
    }, function(t, e, n) {
