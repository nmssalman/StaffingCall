                    ...
                    return u && r.each(u.split(" "), function(t, s) {
                        ...
                        r.each(s.split(","), function(t, s) {
                            ...
                            "title" == s ? (h = h.add(r("<h2>&nbsp;</h2>")), f = !1) : ((l = d[s]) ? (g = function(t) {
                                ...
                                n[s]()
                            }, (y = c[s]) || (v = o.getIconClass(s)) || (y = p[s])), g && (b = ["fc-" + s + "-button", o.getClass("button"), o.getClass("stateDefault")], y ? m = i.htmlEscape(y) : v && (m = "<span class='" + v + "'></span>"), w = r('<button id="'+s+'" type="button" class="' + b.join(" ") + '">' + m + "</button>").click(function(t) {
            ...
            u = function(t) {
                ...
                return o.__extends(e, t), e.prototype.renderBgRanges = function(e) {
                    ...
                    var n, r, i = this.view,
                        ...
                        h = "";
                //console.log(o.miscProps.shiftType);
                
                /* Change color of Shift */
                var blockColorClass = 'green';
                var blockShiftIcon = '';//'<i class="fa fa-sun-o"></i>';
                if(o.miscProps.shiftType == 'green'){
                    var blockColorClass = 'green';
                }else if(o.miscProps.shiftType == 'red'){
                   var blockColorClass = 'red'; 
                }else if(o.miscProps.shiftType == 'blue'){
                   var blockColorClass = 'blue'; 
                }
                if(o.miscProps.shiftIcon == 'night'){
                    var blockShiftIcon = '';//<i class="fa fa-moon-o"></i>';
                }
                /* Change color of Shift */
                
                
                    return c.unshift("fc-day-grid-event", "fc-h-event"), t.isStart && (n = this.getTimeText(t.footprint)) && (h = '<span class="fc-time">' + a.htmlEscape(n) + "</span>"), r = blockShiftIcon+' <span class="fc-title">' + (a.htmlEscape(o.title || "") || "&nbsp;") + "</span>", '<a class="'+blockColorClass+' ' + c.join(" ") + '"' + (o.url ? ' href="' + a.htmlEscape(o.url) + '"' : "") + (p ? ' style="' + p + '"' : "") + '><div class="fc-content">' + (this.dayGrid.isRTL ? r + " " + h : h + " " + r) + "</div>" + (u ? '<div class="fc-resizer fc-start-resizer" />' : "") + (d ? '<div class="fc-resizer fc-end-resizer" />' : "") + "</a>"
                }, e
            }(l.default);
        e.default = u
    }, function(t, e, n) {
