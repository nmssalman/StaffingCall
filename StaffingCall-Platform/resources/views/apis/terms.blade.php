...
<!--[if gt IE 9]><!--> <html lang="{!! app()->getLocale() !!}" class="no-focus"> <!--<![endif]-->
    <head>
        ...
        <meta name="description" content="Staffing-Call Terms Of Service">
        <meta name="author" content="Gaurav">
        <meta name="robots" content="noindex, nofollow">

        <!-- Open Graph Meta -->
        <meta property="og:title" content="Staffing-Call Terms Of Service">
        <meta property="og:site_name" content="Staffing-Call">
        <meta property="og:description" content="Staffing-Call Terms Of Service">
                        ...
                        <div class="py-5 px-5 text-center">
                            ...
                            <h1 class="h2 font-w700 mt-50 mb-10"><a class="link-effect font-w700" href="{!! url('/') !!}">
                                ...
                                <span class="font-size-xl text-primary-dark">
                                    <img width="120" src="{!! url('/assets/img/logo.png') !!}" />
                                </span>
                                
                            </a></h1>
                            <h1 class="h4 font-w400 text-muted mb-0">Terms Of Service</h1>
                        </div>
                        <!-- END Header -->
                        ...
                        <div class="block block-bordered block-rounded mb-5" style="margin-top: 20px;">
                                    ...
                                    <div id="faq1_q1" class="collapse show" role="tabpanel" aria-labelledby="faq1_h1">
                                        <div class="block-content border-t">
                                           ...
                                           <p>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries, but also the leap into electronic typesetting, remaining essentially unchanged. It was popularised in the 1960s with the release of Letraset sheets containing Lorem Ipsum passages, and more recently with desktop publishing software like Aldus PageMaker including versions of Lorem Ipsum.</p>
                                            <p>Potenti elit lectus augue eget 
                                                iaculis vitae etiam, ullamcorper 
                                                etiam bibendum ad feugiat magna accumsan dolor, 
                                                nibh molestie cras hac ac ad massa, fusce ante 
                                                convallis ante urna molestie vulputate bibendum 
                                                tempus ante justo arcu erat accumsan adipiscing 
                                                risus, libero condimentum venenatis sit nisl nisi 
                                                ultricies sed, fames aliquet consectetur consequat 
                                                nostra molestie neque nullam scelerisque neque commodo 
                                                turpis quisque etiam egestas vulputate massa, curabitur 
                                                tellus massa venenatis congue dolor enim integer luctus, 
                                                nisi suscipit gravida fames quis vulputate nisi viverra 
