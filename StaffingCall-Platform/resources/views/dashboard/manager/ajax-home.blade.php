                ...
                <div class="dataTables_paginate paging_simple_numbers" id="datatable_paginate">
                    <ul class="pagination">
                        <li class="paginate_button page-item <?php if(($activePage-1) == 0){ ?>disabled <?php } ?> " id="datatable_previous">
                            <a onclick="performPagingForUnit('<?= $activePage-1 ?>')" href="javascript:void(0);" aria-controls="datatable" data-dt-idx="0" tabindex="0" class="page-link">
                                Previous
                            </a>
                        </li>
                        ...
                        <li class="paginate_button page-item next <?php if($totalPage == $activePage){ ?>disabled <?php } ?>" id="datatable_next">
                            <a onclick="performPagingForUnit('<?= $activePage+1 ?>')" href="javascript:void(0);" aria-controls="datatable" data-dt-idx="2" tabindex="0" class="page-link">
                                Next
                            </a>
                        </li>
                    </ul>
