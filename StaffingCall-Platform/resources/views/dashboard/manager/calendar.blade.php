	...
	$(document).ready(function() {
		...
		jQuery('#calendar').fullCalendar({
			...
			select: function(start, end) {
                        ...
                        if(startHasEvent == false || endHasEvent == false){
               ...
               var requestUrl = '{!! url(Config('constants.urlVar.ajaxCalendarViewOnNextPrevious')) !!}';
                    $.ajax({ 
                            ...
                            success: function(response){
                                location.href = '{!! url(Config('constants.urlVar.userCalendarView').$userBusinessUnitID) !!}';
                            },
                            error:function(e){
                                console.log(e);
                            }
...
<!--                                <button type="button" class="btn-block-option" data-dismiss="modal" aria-label="Close">
  ...
  filter: alpha(opacity=40); /* For IE8 and earlier */
    ...
    function changeView(){
        ...
        location.href = '{!! url(Config('constants.urlVar.businessUnitDetail').$userBusinessUnitID) !!}';
    }
