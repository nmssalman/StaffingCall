...
@section('content')
<div class="content">
<h2 class="content-heading">Staffing Requests Reasons</h2>
         ...
         @endif        
                    ...
                    <div class="block">
                        ...
                        <button onclick="javascript:location.href='{!! url(Config('constants.urlVar.addNewRequestReason')) !!}'" style="margin-left: 16px;cursor: pointer;" class="btn btn-sm btn-info mb-10">Add New</button>
            ...
            <div class="block block-themed block-transparent mb-0" style="max-height: 500px;overflow: auto;">
                <div class="block-header bg-primary-dark">
                    ...
                    <div class="block-options">
                        <h3 style="color:#fff;">Default Request Reasons</h3>
                ...
                <div class="block-content">
                    ...
                    <table class="table table-bordered table-striped table-vcenter js-dataTable-full">
                        ...
                        <tbody id="checkboxes">
                            ...
                            <tr>
                                <td>
                                    <input type="checkbox" id="defaultRequestIDs_{!! $defaultReason->id !!}" name="defaultRequestIDs[]" value="{!! $defaultReason->id !!}"/> 
                                </td>
                                <td>{!! $defaultReason->reasonName !!}
                                @if($defaultReason->id == 1)    
                                <br />
                                <small>(Staff information will be required)</small>
                                @endif
                                </td>
                                <td>
...
var dataUrl = "{!! url(Config('constants.urlVar.ajaxRequestReasonsList')) !!}";

function addSingle(checkBoxID){
    $('#defaultRequestIDs_'+checkBoxID).attr('checked', true);
    addAllReasons();
}
...
function addAllReasons(){
    ...
    if(selected.length > 0){  
        $('#loadingDiv').show();
       var requestUrl = '{!! url(Config('constants.urlVar.saveDefaultRequestReasons')) !!}';
        $.ajax({
            url:requestUrl,
            type:'GET',
            data:{'defaultRequestIDs':selected},
            success:function(result){
                console.log(result);
                //$('#loadingDiv').hide();
                location.href = '{!! url(Config('constants.urlVar.requestReasonsList')) !!}';
               //console.log(result);
            },error:function(er){
