...
<!--        <h2 class="content-heading">Manage Groups</h2>-->
        <div class="block">
            <div class="block-header block-header-default">
                <h3 class="block-title">Add New Request Reason</h3>
            ...
            <div class="block-content">
                <div class="row justify-content-center py-20">
                    <div class="col-xl-10">
                        <form class="js-request-reasons-form-validation-bootstrap" action="{!! url(Config('constants.urlVar.saveRequestReason')) !!}" method="post" enctype="multipart/form-data">
                            ...
                            <div class="form-group row{!! $errors->has('reasonName') ? ' is-invalid' : '' !!}">
                                ...
                                <div class="col-lg-8">
                                    <input type="text" value="{!! old('reasonName') !!}" class="form-control" id="reasonName" name="reasonName" placeholder="Enter Reason of request">
