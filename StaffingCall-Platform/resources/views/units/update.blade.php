...
<!--        <h2 class="content-heading">Manage Groups</h2>-->
        <div class="block">
            <div class="block-header block-header-default">
                <h3 class="block-title">Update Business Unit</h3>
            ...
            <div class="block-content">
                <div class="row justify-content-center py-20">
                    <div class="col-xl-10">
                        <form class="js-unit-create-validation-bootstrap" action="{!! url(Config('constants.urlVar.updateBusinessUnit')) !!}" method="post" enctype="multipart/form-data">
                            ...
                            <div class="form-group row{!! $errors->has('unitName') ? ' is-invalid' : '' !!}">
                                ...
                                <div class="col-lg-8">
                                    <input type="text" value="{!! $units->unitName !!}" class="form-control" id="unitName" name="unitName" placeholder="eg. NICU">
                            ...
                            <div class="form-group row{!! $errors->has('storeNumber') ? ' is-invalid' : '' !!}">
                                ...
                                <div class="col-lg-8">
                                    <input type="text" value="{!! $units->storeNumber !!}" class="form-control" id="storeNumber" name="storeNumber" placeholder="Enter Store Number">
                            ...
                            <div class="form-group row{!! $errors->has('information') ? ' is-invalid' : '' !!}">
                                ...
                                <div class="col-lg-8">
                           <textarea class="form-control" id="information" name="information" placeholder="Enter Business Unit Information">{!! $units->information !!}</textarea>
                            ...
                            <div class="form-group row{!! $errors->has('offerAlgorithmID') ? ' is-invalid' : '' !!}">
                                ...
                                <div class="col-md-4">
                                    @php $chkIsComplexAlgorithm = 0 @endphp
                                    <select class="js-select2 form-control" id="offerAlgorithmID" name="offerAlgorithmID" style="width: 100%;" data-placeholder="Choose Offer Algorithm..">
                                        ...
                                        <!-- Required for data-placeholder attribute to work with Select2 plugin -->
                                         @foreach($algorithms as $algorithm)
                                            @if($units->offerAlgorithmID == $algorithm->id && $algorithm->type == 'complex')
                                              @php $chkIsComplexAlgorithm = 1; @endphp  
                                            @endif
                                        <option itemid="{!! $algorithm->type !!}" @if($units->offerAlgorithmID == $algorithm->id) selected @endif value="{!! $algorithm->id !!}">{!! $algorithm->name." ( ".ucfirst($algorithm->type)." )" !!}</option>
                                        @endforeach
                                    </select>
                            ...
                            @php $displayVar = 'none'  @endphp
                            @if($chkIsComplexAlgorithm == 1)
                                @php $displayVar = 'block' @endphp
                            @endif
                            <div id="complexOrderDisplay" style="display:<?= $displayVar ?>">
                                ...
                                <table class="table table-bordered table-striped table-vcenter js-dataTable-full" id="algorithmTable">
                                    <thead>
                                    <th colspan="2">Drag to reorder</th>
