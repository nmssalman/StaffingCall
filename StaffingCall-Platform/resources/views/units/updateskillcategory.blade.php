...
<!--        <h2 class="content-heading">Manage Groups</h2>-->
        <div class="block">
            <div class="block-header block-header-default">
                <h3 class="block-title">Update Skills Category</h3>
            ...
            <div class="block-content">
                <div class="row justify-content-center py-20">
                    <div class="col-xl-10">
                        <form class="js-skill-create-validation-bootstrap" action="{!! url(Config('constants.urlVar.updateSkillCategory')) !!}" method="post" enctype="multipart/form-data">
                            ...
                            <div class="form-group row{!! $errors->has('skillName') ? ' is-invalid' : '' !!}">
                                ...
                                <div class="col-lg-8">
                                    <input type="text" value="{!! $skills->skillName !!}" class="form-control" id="skillName" name="skillName" placeholder="Enter skill category name">
