...
<!--[if gt IE 9]><!--> <html lang="{!! app()->getLocale() !!}" class="no-focus"> <!--<![endif]-->
    <head>
        ...
        <title>StaffingCall | Generate Login ID and Pasword</title>

        <meta name="description" content="StaffingCall Login">
        <meta name="author" content="Gaurav">
        <meta name="robots" content="noindex, nofollow">

        <!-- Open Graph Meta -->
        <meta property="og:title" content="StaffingCall Reset Password">
        <meta property="og:site_name" content="StaffingCall">
        <meta property="og:description" content="StaffingCall Login">
        ...
        <div id="page-container" class="main-content-boxed">
            ...
            <main id="main-container">
                ...
                <div class="bg-gd-dusk">
                    <div class="hero-static content content-full bg-white invisible" data-toggle="appear">
                        ...
                        <div class="py-30 px-5 text-center">
                            ...
                            <h2 class="h4 font-w400 text-muted mb-0">Create your Login-ID and Password</h2>
                        </div>
                        <!-- END Header -->
                        ...
                        <div class="row justify-content-center px-5">
                            <div class="col-sm-8 col-md-6 col-lg-4">
                                 ...
                                 <form  class="js-validation-generate-username-pass" method="POST" action="{!! url(Config('constants.urlVar.GenerateLoginIDAndPassword').$token) !!}" role="form" data-parsley-validate novalidate>
                ...
                <div class="form-group row">
                    <div class="col-12">
                        <div class="form-material floating{!! $errors->has('userName') ? ' has-error' : '' !!}">
                            <input style="color: #fff;" type="text" class="form-control" id="userName" name="userName">
                            <label for="userName">Login-ID</label>
                            
                                @if ($errors->has('userName'))
                                <div style="display: block;" id="userName-error" class="invalid-feedback animated fadeInDown">
                        ...
                        <div class="form-material floating{!! $errors->has('password') ? ' has-error' : '' !!}">
                            ...
                            <label for="password">Password</label>
                                ...
                                @if ($errors->has('password'))
                                    <div style="display: block;" id="password-error" class="invalid-feedback animated fadeInDown">
                        ...
                        <div class="form-material floating{!! $errors->has('password_confirmation') ? ' has-error' : '' !!}">
                            ...
                            <label for="password_confirmation">Confirm Password</label>
                                ...
                                @if ($errors->has('password_confirmation'))
                                    ...
                                    <div style="display: block;" id="password_confirmation-error" class="invalid-feedback animated fadeInDown">
                ...
                <div class="form-group row gutters-tiny">
                    <div class="col-12 mb-10">
                        <button style="cursor: pointer;" type="submit" class="btn btn-block btn-hero btn-noborder btn-rounded btn-alt-primary">
                            <i class="si si-login mr-10"></i> Generate
                        </button>
                    </div>
