                ...
                <div class="dataTables_paginate paging_simple_numbers" id="datatable_paginate">
                    <ul class="pagination">
                        <li class="paginate_button page-item previous disabled" id="datatable_previous">
                            <a onclick="performPagingForGroupDetail('0')" href="javascript:void(0);" aria-controls="datatable" data-dt-idx="0" tabindex="0" class="page-link">
                                Previous
                            </a>
                        </li>
                        ...
                        <li class="paginate_button page-item next <?php if($totalPage == 1){ ?>disabled <?php } ?>" id="datatable_next">
                            <a onclick="performPagingForGroupDetail('2')" href="javascript:void(0);" aria-controls="datatable" data-dt-idx="2" tabindex="0" class="page-link">
                                Next
                            </a>
                        </li>
                    </ul>
